'use client'
import { } from 'react'
export default function Error error, reset }: { error: Error & digest?: string };: () => void {
  useEffect(() => { console.error(error }, [error])
 return (
    < className="min-h flex items-center justify bg-zinc-50">
      <div="text-center max-md p-8        <div className="w-16 h-16 bg-red-100 rounded-2xl flex items-center justify-center text-2xl mx-auto mb-6">⚠</div>
